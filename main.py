...
BotConfig = BotConfig().iniate()
print(BotConfig)
bot = commands.Bot(command_prefix=BotConfig.Prefix.value)
...
if __name__ == "__main__":
    ...
    for command in commands_files:
        try:
            ...
            print(f'[ERR] Failed to load extension {command[:-3]} : {error}')
